                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse main-menu-item justify-content-end"
                        ...
                        <ul class="navbar-nav align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('courses.index') }}">課程</a>
                            </li>
                            ...
                            @auth
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('enroll.myCourses') }}">我的課程</a>
                                </li>
                                <li class="d-none d-lg-block">
                                    <a class="btn_1" href="#" onclick="event.preventDefault(); document.getElementById('logoutform').submit();">登出</a>
